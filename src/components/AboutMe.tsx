          ...
          <div className="about-body">
            ...
            <div className="about-text-container">
              <p className="body-text">
                Hi! I'm Ryan, a Computer Science student at UC Irvine with a
                passion for tech. I specialize in Intelligent Systems and have a
                knack for problem-solving. I've honed my skills in Python, C++,
                React, and more, and I've applied them during my internship at
                Pearl AI this past summer. There, I helped develop a full-stack
                application for real-time image analysis.
              </p>
              <p className="body-text">
                I'm also a researcher who uses computational simulations to
                explore wildfire behavior and its relationship to climate
                change. When I'm not studying or working, I'm bringing
                creativity to events as a Student Talent Intern at UCI
                Associated Students. I also love to surf and play music!
              </p>
              <p className="body-text">
